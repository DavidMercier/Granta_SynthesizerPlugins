...
namespace UserModel
{
    ...
    [BindableDisplay(Name = "Ni-SiC", Description = "Example models for metallic matrix composites.", GroupName = "Examples")]
    ...
    public class ExampleModel
    {
        ...
        [CalculatedData("SiC (silicon carbide)", "%")]
        public double SiC()
        {
            return percentage;
        }
